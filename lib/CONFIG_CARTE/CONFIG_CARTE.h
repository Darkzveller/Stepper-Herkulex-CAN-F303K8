...
#define HERKULEX_PIVOT_PINCE HERKULEX_AVANT_PIVOT_PINCE + OFFSET_CARTE_MPP
#define HERKULEX_PINCE HERKULEX_AVANT_PINCE + OFFSET_CARTE_MPP
#define CONSTRUIRE_2ETAGE CONSTRUIRE_AVANT_2ETAGE + OFFSET_CARTE_MPP
#define CONTRUIRE_PREPARER CONSTRUIRE_AVANT_PREPARER + OFFSET_CARTE_MPP
